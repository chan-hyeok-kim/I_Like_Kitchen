...
<body>
					...
					<div class="col-lg-6">
						<ul class="tn-left">
							...
							<li><i class="fa fa-envelope"></i>
								info.ILikeKitchen@gmail.com</li>
						</ul>
					</div>
					<div class="col-lg-6">
						<div class="tn-right">
	...
	<div class="floatingBar">
		<img alt="" src="/resources/icon/free-icon-backlog-1.png"> <br>
		자주 찾는 질문
	</div>
	<!-- Search model end -->
...
<script>
	$('.floatingBar').click(function() {
			location.href = 'https://www.notion.so/d87dd9eefdde460f90a773b47fa833f3?pvs=4'
