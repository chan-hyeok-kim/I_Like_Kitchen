...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=367c3993888d805f9a675197a5be6e56&libraries=services&autoload=false"></script>
</head>
...
<body>
    ...
    <section id="product-wrapper-section" class="container">
        <div class="row" id="product-contents-div1">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm border-primary">
                        ...
                        <div class="card-body" id="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                                ...
                                <li><a href="#map"><img alt="" src="/resources/icon/free-icon-location-5.png">위치</a></li>
                            </ul>
            ...
            <div style="font-weight: bold" class="text-warn"><span>
            <p style="font-weight: bold"><img src="/resources/icon/free-icon-warning-6.png">직거래 유도 주의 안내
            <img src="/resources/icon/free-icon-warning-6.png">
            </p> </span> </div>
           <p class="text-warn">호스트 현금 결제 유도 시, 신고바랍니다. 아이라이크키친은 현금 직거래로 발생하는 사고를 책임 지지 않습니다.</p>
         ...
         <div id="contents-notice">(고객 미숙지로 인한 불이익 시 아이라이크키친이 책임지지 않습니다.)</div>
          ...
          ${kto.contents}
            ...
            <div id="product-question">
             <div id="question-title">문의</div>
            </div>
            
             <div id="product-review">
             <div id="review-title">후기</div>
            </div>
            
            <div id="product-map"><p>위치</p></div>
...
<button id="del" class="btn btn-outline-primary">삭제</button>
